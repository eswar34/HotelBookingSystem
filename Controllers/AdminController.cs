...
namespace HotelBookingSystem.API.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public AdminController(IAuthService authService, IUserService userService, IHotelService hotelService, IBookingService bookingService)
        {
        ...
        public async Task<IActionResult> Login(LoginDto dto)
        {
            ...
            if (!string.Equals(result.User.Role, "Admin", StringComparison.OrdinalIgnoreCase))
                throw new UnauthorizedAccessException("Only admin users can access this endpoint.");
